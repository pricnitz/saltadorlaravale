...
@section('content')
    ...
    <div class="banner-header middle-height section-padding valign bg-img bg-imgfixed" data-overlay-dark="5"
           data-background="{{asset('frontend/img/services/pm.jpg')}}">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row mb-60">
                <div class="col-lg-6 col-md-12">
                    <p class="mb-60"><span class="first-letter">U</span>Saltador provides pm-design programming, land
                ...
                <div class="col-lg-5 offset-lg-1 col-md-12">
                    <img class="vert-move" src="{{asset('frontend/img/services/pm.jpg')}}" alt="project managment">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6 col-md-12 mb-30">
                    ...
                    <ul class="list-unstyled list">
                        ...
                        <li class="d-flex mb-4">
                            ...
                            <div class="list-text">
                                <h6 class="mb-1 text-warning">Development / Context Planning</h6>
                                <p class="mb-0">
                        ...
                        <li class="d-flex mb-4">
                            ...
                            <div class="list-text">
                                <h6 class="mb-1 text-warning">Feasibility Design Studies</h6>
                                <p class="mb-0">
                        ...
                        <li class="d-flex mb-4">
                            ...
                            <div class="list-text">
                                <h6 class="mb-1 text-warning">Design Development</h6>
                                <p class="mb-0">
                        ...
                        <li class="d-flex">
                            ...
                            <div class="list-text">
                                <h6 class="mb-1 text-warning">Landscape & Visual Assessment</h6>
                                <p class="mb-0">
